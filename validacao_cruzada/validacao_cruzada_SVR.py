# -*- coding: utf-8 -*-
"""
Created on Fri May 22 17:48:44 2026
...
_VC_PADRONIZACAO          = True
_VC_PADRONIZACAO_OBJETIVO = True
...
for indice_treinamento, indice_teste in kfold.split(previsores):
    ...
    regressor = SVR(kernel='rbf', C=1.0, gamma='scale', epsilon=0.2 )
...
# MODIFICAÇÃO: Correção estrutural para garantir a criação da variável previsoes_treinamento em todas as escalas e evitar o NameError
if _VC_PADRONIZACAO:
    previsoes_treinamento = regressor.predict(X_treino_scaled)
    if _VC_PADRONIZACAO_OBJETIVO:
        previsoes_treinamento = _scaler_y.inverse_transform(previsoes_treinamento.reshape(-1, 1)).ravel()
else:
